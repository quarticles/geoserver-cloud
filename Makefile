...
package-base-images:
ifeq ($(REPACKAGE), true)
	./mvnw clean install -DskipTests -T1C -ntp -U -am -pl src/apps/base-images/jre,src/apps/base-images/spring-boot,src/apps/base-images/spring-boot3,src/apps/base-images/geoserver
else
...
ifeq ($(REPACKAGE), true)
	./mvnw clean install -DskipTests -T1C -ntp -U -am -pl src/apps/infrastructure/config,src/apps/infrastructure/discovery,src/apps/infrastructure/gateway
else
...
ifeq ($(REPACKAGE), true)
	./mvnw clean install -DskipTests -T1C -ntp -U -am -pl src/apps/geoserver/gwc,src/apps/geoserver/restconfig,src/apps/geoserver/wcs,src/apps/geoserver/webui,src/apps/geoserver/wfs,src/apps/geoserver/wms,src/apps/geoserver/wcs,src/apps/geoserver/wps
else
